...
#define RK_METHOD_ADAPTIVE(weights_a, weights_b, weights_bh,                                  \
    ...
    {                                                                                         \
        ...
        {                                                                                     \
            ...
            /* evaluate next k */                                                             \
            f(t + h * weights_c[stage], y_stage, k[stage], &halt, cfg);                       \
            result->n_fev++;                                                                  \
        }                                                                                     \
                                                                                              \
...
RKSolution *rk89(void (*f)(double, double[VEC_SIZE], double[VEC_SIZE], bool *, ConfigStruct *),
...
RKSolution *rk89_fixed(void (*f)(double, double[VEC_SIZE], double[VEC_SIZE], bool *, ConfigStruct *),
                       double t0, double tf, ConfigStruct *cfg){
#define RK89_STAGES 16
#define RK89_ORDER 9
...
RKSolution *rk78(void (*f)(double, double[VEC_SIZE], double[VEC_SIZE], bool *, ConfigStruct *),
                 double t0, double tf, ConfigStruct *cfg){
...
RKSolution *rk67(void (*f)(double, double[VEC_SIZE], double[VEC_SIZE], bool *, ConfigStruct *),
                 double t0, double tf, ConfigStruct *cfg){
...
RKSolution *rk56(void (*f)(double, double[VEC_SIZE], double[VEC_SIZE], bool *, ConfigStruct *),
                 double t0, double tf, ConfigStruct *cfg){
...
RKSolution *rk810(void (*f)(double, double[VEC_SIZE], double[VEC_SIZE], bool *, ConfigStruct *),
                  double t0, double tf, ConfigStruct *cfg){
...
RKSolution *rk1012(void (*f)(double, double[VEC_SIZE], double[VEC_SIZE], bool *, ConfigStruct *),
                   double t0, double tf, ConfigStruct *cfg){
...
RKSolution *rk1214(void (*f)(double, double[VEC_SIZE], double[VEC_SIZE], bool *, ConfigStruct *),
                   double t0, double tf, ConfigStruct *cfg)
{
