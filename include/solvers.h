...
RKSolution *rk810(void (*f)(double, double[VEC_SIZE], double[VEC_SIZE]),
                  double t0, double tf, double y0[VEC_SIZE], double h0, double tol){
#define RK810_STAGES 17
#define RK810_ORDER 10
    RK_METHOD(rk810_a, rk810_b, rk810_bh, rk810_c, RK810_ORDER, RK810_STAGES)}

// Less robust 12th order method
RKSolution *rk1012(void (*f)(double, double[VEC_SIZE], double[VEC_SIZE]),
                   double t0, double tf, double y0[VEC_SIZE], double h0, double tol){
#define RK1012_STAGES 25
#define RK1012_ORDER 12
    RK_METHOD(rk1012_a, rk1012_b, rk1012_bh, rk1012_c, RK1012_ORDER, RK1012_STAGES)}

// Less robust 14th order method
RKSolution *rk1214(void (*f)(double, double[VEC_SIZE], double[VEC_SIZE]),
                   double t0, double tf, double y0[VEC_SIZE], double h0, double tol)
{
#define RK1214_STAGES 35
#define RK1214_ORDER 14
    RK_METHOD(rk1214_a, rk1214_b, rk1214_bh, rk1214_c, RK1214_ORDER, RK1214_STAGES)
}
